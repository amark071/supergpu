...
\definecolor{MumpsBlue}{RGB}{0,91,172}
\definecolor{MumpsCyan}{RGB}{0,158,166}
\definecolor{MumpsRed}{RGB}{196,50,48}
\tikzset{
  mumps fully summed/.style={fill=MumpsBlue!16},
  mumps factor/.style={fill=MumpsCyan!12},
  mumps delayed/.style={fill=MumpsRed!10},
  mumps contribution/.style={fill=gray!13},
  mumps active/.style={fill=gray!7},
  mumps emphasis/.style={draw=MumpsRed,very thick}
}
